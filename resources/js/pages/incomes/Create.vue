            ...
            <div class="rounded-lg border bg-card p-4">
                <Form :action="store_url" method="post" class="space-y-4" v-slot="{ errors, processing }">
                    <div class="grid gap-2">
                        ...
                        <Input id="name" name="name" required maxlength="29" placeholder="Income name" />
                    ...
                    <div class="grid gap-2">
                        ...
                        <select id="account_id" name="account_id" class="h-9 rounded-md border bg-background px-3 text-sm" required>
