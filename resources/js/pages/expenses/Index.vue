...
function applyFilters(next: Partial<Filters>) {
    router.get(
        props.index_url,
        {
            ...
            payment_method_id:
                next.payment_method_id ?? props.filters.payment_method_id,
    ...
    <AppShell>
        <div class="space-y-6">
            ...
            <div class="rounded-lg border bg-card p-4">
                <div class="grid gap-4 md:grid-cols-3">
                    <div class="grid gap-2">
                        <label class="text-sm font-medium" for="category_id"
                            >Category</label
                        >
                        <select
                            id="category_id"
            ...
            <div class="rounded-lg border bg-card">
                    ...
                    >
                        <div class="space-y-1">
                            ...
                            <div class="text-xs text-muted-foreground">
                                ...
                                <span v-if="expense.payment_method">{{
                ...
                <div
                    v-if="expenses.links && expenses.links.length > 0"
