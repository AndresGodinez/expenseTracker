...
* @see app/Http/Controllers/PaymentMethodController.php:12
...
* @see app/Http/Controllers/PaymentMethodController.php:31
...
* @see app/Http/Controllers/PaymentMethodController.php:39
* @route '/payment-methods'
*/
...
* @see app/Http/Controllers/PaymentMethodController.php:52
...
const PaymentMethodController = { index, create, store, edit, update, destroy }
