...
<template>
    ...
    >
        <div
            class="flex items-center justify-between border-b border-slate-200 bg-slate-100/70 px-3 py-2"
        >
            ...
            <div class="mx-3 flex-1">
                <div
                    class="truncate rounded-md border border-slate-200 bg-white/70 px-3 py-1 text-xs text-slate-700"
                >
                    {{ url }}
                </div>
            </div>
